...
public class C04_PageClassTest {
        ...
        public void withoutPageClass() {
            ...
            WebElement signIn = driver.findElement(By.xpath("//button[@aria-label='Oturum açın']"));
            signIn.click();

            WebElement errorMessage = driver.findElement(By.id("error-for-username"));
            Assert.assertTrue(errorMessage.getText().contains("Bu e-posta adresi ile"));
        ...
        public void withPageClass(){
            ...
            Assert.assertTrue(errorMessage.contains("Bu e-posta adresi ile"));
